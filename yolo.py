...
from main_structure.yolo import YoloBody
...
class YOLO(object):
    ...
    def generate(self, onnx=False):
        ...
        self.net.load_state_dict(torch.load(self.model_path, map_location=device,weights_only=True), strict=False)
    ...
    def detect_image(self, image, img_name, crop = False, count = False):
        ...
        font        = ImageFont.truetype(font='Category_Files/simhei.ttf', size=np.floor(3e-2 * image.size[1] + 0.5).astype('int32'))
