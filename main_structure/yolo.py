...
from main_structure.backbone import Backbone, C2f, Conv
from main_structure.yolo_training import weights_init
...
class YoloBody(nn.Module):
	def __init__(self, input_shape, num_classes, phi, pretrained=False):
		...
		# self.upsample_1 = EUCB(base_channels * 8, base_channels * 8)
		...
		# self.conv3_for_upsample2 = EFC(base_channels * 8, base_channels * 4)
		
		# 256, 80, 80 => 256, 40, 40
		self.down_sample1 = Conv(base_channels * 4, base_channels * 4, 3, 2)
		# 512 + 256, 40, 40 => 512, 40, 40
		self.conv3_for_downsample1 = ACmix(base_channels * 8 + base_channels * 12, base_channels * 8)
		# self.conv3_for_downsample1 = EFC(base_channels * 4, base_channels * 8)
		...
		# self.conv3_for_downsample2 = EFC(base_channels * 8, int(base_channels * 16 * deep_mul))
	...
	def parallel_fpn(self, feat1, feat2, feat3):
		...
		# print(f"P5_upsample_shape{P5_upsample.shape}")
		# print(f"feat2_shape{feat2.shape}")
